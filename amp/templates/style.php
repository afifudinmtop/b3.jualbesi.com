...
/* apip css */
	...
	.wa_tombol{
		background-image: url('/apip/wa.png');
	...
	.apip_menu2{
		background-repeat: no-repeat;
		background-image: url("/apip/menu.png");
		padding: 0px!important;
		width: 30px;
		height: 30px;
		margin-top: 6px!important;
	...
	.apip_sidebar_footer1{
		position: absolute;
		bottom: 60px;
	}

	.apip_sidebar_footer2{
		font-size: 14px;
		line-height: 40px;
	}

	.apip_sidebar_footer3{
		font-size: 14px;
    line-height: 18px;
	}

	.apip_sidebar_footer4{
		background-image: url(/wp-content/uploads/2018/02/cropped-ana-1.png);
		width: 170px;
		height: 100px;
		background-repeat: no-repeat;
